...
export async function GET(request: NextRequest, context: DemoRouteContext): Promise<Response> {
  ...
  if (accept.includes('text/event-stream')) {
    return createDemoSseResponse(request, demoId, conversationId, requestContext);
  }
