...
const statusSourcePath = path.join(repoRoot, 'docs/feature-status.json');
const implementationStatusPath = path.join(repoRoot, 'docs/implementation-status.md');
const featureMatrixPath = path.join(repoRoot, 'docs/feature-matrix.md');
...
function renderImplementationStatus(data) {
  ...
  const lines = [
    ...
    '',
    '> Generated from `docs/feature-status.json` by `scripts/render-feature-status.mjs`. Do not edit this file by hand.',
    '',
...
function renderFeatureMatrix(data) {
  const lines = [
    ...
    '> Generated from `docs/feature-status.json` by `scripts/render-feature-status.mjs`. Do not edit this file by hand.',
    '',
    'Quick-scan summary for planning and safe edits. For full evidence and notes, use [implementation-status.md](./implementation-status.md).',
    '',
  ...
  lines.push(
    ...
    '',
    '[implementation-status.md](./implementation-status.md) contains full evidence and details.',
    '',
  );
